...
(function (global) {
  ...
  var DICT = {
    ...
    ru: {
      ...
      "ovr.caption":
        "Запас в днях — остаток, делённый на скорость продаж за {w} дней. Порог {t} дня — первая корзина надбавки за выдержанный запас в самом отчёте. Колонка «Излишек» — собственный расчёт сверх {c} дней покрытия, а не оценка Amazon: её отчёт часто отдаёт нулём.",
      ...
      "ovr.kpi.storage12m": "Хранение, факт",
      "ovr.kpi.storagePastNote": "{from} — {to} · месяцев: {n}",
      "ovr.kpi.noSeason": "Следующий месяц {s} · без поправки на сезон",
      "ovr.kpi.storage3m": "Прогноз хранения, 3 мес",
      "ovr.kpi.storage3mNote": "Следующий месяц {s} · сезон: окт ×{o}, ноя ×{n}",
      ...
      /* --- Раздел «Страны доставки»: разрез по стране получателя --- */
      "page.geo": "Страны доставки",
      "geo.subtitle": "Сколько и чего продано в странах, куда едут посылки",
      "geo.empty":
        "В выгрузке нет узла countries. Он собирается src/Export-CountrySales.ps1 из Orders Report и вкладывается src/Add-CountriesToPayload.ps1.",
      "geo.range": "Период {from} — {to} · {d} дней · Orders Report, поле ship-country",
      "geo.caption":
        "Страна здесь — куда уехала посылка, а не где оформлен заказ. Покупка на витрине одной страны с доставкой в соседнюю попадёт сюда по адресу получателя, а в разделе «Маржа» останется внутри витрины. Период задан при выгрузке и общему фильтру не подчиняется. Все суммы в евро: витрины еврозонные, пересчёт курсов не применялся.",
      "geo.countryPick": "Страна",
      "geo.allCountries": "Все страны ({n})",
      "geo.byCountry": "Продажи по странам",
      "geo.byCountryCaption": "Сумма с НДС за весь период",
      "geo.trend": "Помесячно",
      "geo.trendCaption":
        "Выручка нетто и прибыль — обе в евро, поэтому шкала одна. Штуки — другая единица, они в таблице.",
      "geo.products": "Товары: штуки и деньги",
      "geo.productsCaption":
        "Каждая строка сходится: нетто − возвраты − комиссии − реклама − себестоимость = прибыль. Комиссии, реклама и возвраты разнесены с витринной статистики по доле штук; себестоимость — закупочная цена на дату продажи. Название приведено к одному варианту на ASIN — тому, на который пришлось больше всего проданных единиц.",
      "geo.gaps": "Чего в этих цифрах нет",      "geo.gap.tz": "День берётся по purchase-date в UTC — на границах периода это может отличаться от местного времени витрины.",      "geo.gap.storefront": "Отменённые позиции и канал Non-Amazon исключены; заказы, ещё не отгруженные, учтены как проданные.",
      "geo.kpi.gross": "Сумма продаж",
      "geo.kpi.grossNote": "С НДС — то, что заплатили покупатели",      "geo.kpi.units": "Продано штук",
      "geo.kpi.unitsNote": "Единиц товара, а не позиций заказа",      "geo.kpi.orders": "Заказов",
      "geo.kpi.ordersNote": "Средний чек {v} с НДС",      "geo.col.country": "Страна",
      "geo.col.product": "Товар",
      "geo.col.asin": "ASIN",
      "geo.col.units": "Штук",      "geo.col.gross": "Сумма с НДС",      "geo.col.month": "Месяц",
      "geo.kpi.profit": "Прибыль",
      "geo.kpi.profitNote": "Маржа {m} от выручки нетто · подписка Amazon не разнесена",
      "geo.kpi.profitNoCogs": "Закупочная цена неизвестна — прибыль не считается",
      "geo.kpi.marginMeter": "Маржа",
      "geo.kpi.grossShare": "{p} выборки",
      "geo.kpi.netRev": "Выручка нетто",
      "geo.kpi.netRevNote": "Без НДС ({v}) и промо-скидок ({p})",
      "geo.kpi.refunds": "Возвраты",
      "geo.kpi.refundsNote": "≈{n} шт · разнесено с витринной статистики",
      "geo.kpi.fees": "Комиссии Amazon",
      "geo.kpi.feesNote": "{p} выручки нетто · с поправкой на направление доставки",
      "geo.kpi.ads": "Реклама",
      "geo.kpi.adsNote": "{p} выручки нетто · разнесено по доле штук",
      "geo.kpi.cogs": "Себестоимость",
      "geo.kpi.cogsNote": "Закупочная цена на дату продажи — точная, не разнесённая",
      "geo.col.netRev": "Нетто",
      "geo.col.refunds": "Возвраты",
      "geo.col.fees": "Комиссии",
      "geo.col.ads": "Реклама",
      "geo.col.cogs": "Себест.",
      "geo.col.profit": "Прибыль",
      "geo.col.margin": "Маржа",
      "geo.gap.method": "Комиссии, реклама и возвраты приходят от Amazon по витрине и товару — страны получателя в этих данных нет. Здесь они разнесены по доле штук товара, уехавшей в страну с той же витрины в том же месяце. Это расчётная модель; выручка, штуки и себестоимость — точные.",
      "geo.gap.fba": "FBA-комиссия зависит от направления: доставка в страну без склада Amazon дороже домашней. Разница учтена по фактическим ставкам из банковских расчётов за последние месяцы периода; на более ранние месяцы ставки приняты теми же.",
      "geo.gap.refundDate": "Возвраты учтены по дате события внутри периода: возврат, случившийся после его конца, в эти цифры не попал.",
      "geo.gap.subs": "Подписка продавца — аккаунтная и по странам не разнесена; здесь это меньше трети процента выручки.",
      "geo.partialMonth": "на графике нет неполного месяца: {m}",
    ...
    en: {
      ...
      "ovr.caption":
        "Days of supply is stock divided by the sales rate over {w} days. The {t}-day threshold is the first aged-inventory surcharge bucket present in the report itself. The Excess column is our own calculation beyond {c} days of cover, not Amazon's estimate — that field often comes back as zero.",
      ...
      "ovr.kpi.storage12m": "Storage, actual",
      "ovr.kpi.storagePastNote": "{from} — {to} · months: {n}",
      "ovr.kpi.noSeason": "Next month {s} · no seasonal adjustment",
      "ovr.kpi.storage3m": "Storage forecast, 3 months",
      "ovr.kpi.storage3mNote": "Next month {s} · season: Oct ×{o}, Nov ×{n}",
      ...
      /* --- Ship-to countries: the destination cut --- */
      "page.geo": "Ship-to countries",
      "geo.subtitle": "What sold, and how much, in the countries parcels travel to",
      "geo.empty":
        "The payload has no countries node. It is built by src/Export-CountrySales.ps1 from the Orders Report and embedded by src/Add-CountriesToPayload.ps1.",
      "geo.range": "Period {from} — {to} · {d} days · Orders Report, ship-country field",
      "geo.caption":
        "Country here means where the parcel went, not where the order was placed. A purchase on one country's storefront shipped to a neighbouring one lands here under the recipient address, while the Margin section keeps it inside the storefront. The period is fixed at export time and does not follow the global filter. All amounts are in euro: the storefronts are eurozone ones, no FX conversion was applied.",
      "geo.countryPick": "Country",
      "geo.allCountries": "All countries ({n})",
      "geo.byCountry": "Sales by country",
      "geo.byCountryCaption": "Amount incl. VAT for the whole period",
      "geo.trend": "By month",
      "geo.trendCaption":
        "Net revenue and profit are both in euro, hence one scale. Units are a different measure — they live in the table.",
      "geo.products": "Products: units and money",
      "geo.productsCaption":
        "Every row adds up: net − refunds − fees − advertising − COGS = profit. Fees, advertising and refunds are apportioned from storefront statistics by unit share; COGS is the purchase price on the sale date. The title is reduced to one variant per ASIN — the one carrying the most units sold.",
      "geo.gaps": "What these figures do not include",      "geo.gap.tz": "The day comes from purchase-date in UTC — at the period edges that can differ from the storefront local time.",      "geo.gap.storefront": "Cancelled items and the Non-Amazon channel are excluded; orders not yet shipped count as sold.",
      "geo.kpi.gross": "Sales amount",
      "geo.kpi.grossNote": "Incl. VAT — what buyers paid",      "geo.kpi.units": "Units sold",
      "geo.kpi.unitsNote": "Units of product, not order lines",      "geo.kpi.orders": "Orders",
      "geo.kpi.ordersNote": "Average order {v} incl. VAT",      "geo.col.country": "Country",
      "geo.col.product": "Product",
      "geo.col.asin": "ASIN",
      "geo.col.units": "Units",      "geo.col.gross": "Incl. VAT",      "geo.col.month": "Month",
      "geo.kpi.profit": "Profit",
      "geo.kpi.profitNote": "Margin {m} of net revenue · Amazon subscription not apportioned",
      "geo.kpi.profitNoCogs": "Purchase price unknown — profit is not computed",
      "geo.kpi.marginMeter": "Margin",
      "geo.kpi.grossShare": "{p} of the selection",
      "geo.kpi.netRev": "Net revenue",
      "geo.kpi.netRevNote": "Excl. VAT ({v}) and promo discounts ({p})",
      "geo.kpi.refunds": "Refunds",
      "geo.kpi.refundsNote": "≈{n} units · apportioned from storefront statistics",
      "geo.kpi.fees": "Amazon fees",
      "geo.kpi.feesNote": "{p} of net revenue · adjusted for the delivery destination",
      "geo.kpi.ads": "Advertising",
      "geo.kpi.adsNote": "{p} of net revenue · apportioned by unit share",
      "geo.kpi.cogs": "COGS",
      "geo.kpi.cogsNote": "Purchase price on the sale date — exact, not apportioned",
      "geo.col.netRev": "Net",
      "geo.col.refunds": "Refunds",
      "geo.col.fees": "Fees",
      "geo.col.ads": "Ads",
      "geo.col.cogs": "COGS",
      "geo.col.profit": "Profit",
      "geo.col.margin": "Margin",
      "geo.gap.method": "Amazon reports fees, advertising and refunds by storefront and product — the recipient country does not exist in that data. Here they are apportioned by the share of the product's units that went to the country from the same storefront in the same month. This is a model; revenue, units and COGS are exact.",
      "geo.gap.fba": "The FBA fee depends on the destination: delivery to a country without an Amazon warehouse costs more than domestic. The difference is applied from actual per-unit rates in the settlement reports covering the last months of the period; earlier months are assumed to have the same rates.",
      "geo.gap.refundDate": "Refunds are counted by event date within the period: a refund that happened after its end is not in these figures.",
      "geo.gap.subs": "The seller subscription is account-wide and not apportioned by country; here it is under a third of a percent of revenue.",
      "geo.partialMonth": "the chart omits the partial month: {m}",
    ...
    uk: {
      ...
      /* --- Розділ «24»: затоварення і зберігання --- */
      "page.ovr24": "24",
      "ovr.subtitle": "Затоварення, вік запасу та комісії за зберігання",
      "ovr.empty": "У вивантаженні немає вузла overstock. Потрібен звіт FBA Manage Inventory Health — його збирає src/Export-FbaInventoryHealth.ps1.",
      "ovr.snapshot": "Знімок запасів на {d} · вітрини: {m}",
      "ovr.caption":
        "Запас у днях — залишок, поділений на швидкість продажів за {w} днів. Поріг {t} дня — перша корзина надбавки за витриманий запас у самому звіті. Колонка «Надлишок» — власний розрахунок понад {c} днів покриття, а не оцінка Amazon: її звіт часто віддає нулем.",
      "ovr.kpi.stockValue": "Заморожено в запасі",
      "ovr.kpi.stockValueNote": "{n} одиниць на складі",
      "ovr.kpi.inboundValue": "У дорозі",
      "ovr.kpi.inboundValueNote": "{n} одиниць їде на склад",
      "ovr.kpi.storage12m": "Зберігання, факт",
      "ovr.kpi.storagePastNote": "{from} — {to} · місяців: {n}",
      "ovr.kpi.noSeason": "Наступний місяць {s} · без поправки на сезон",
      "ovr.kpi.storage3m": "Прогноз зберігання, 3 міс",
      "ovr.kpi.storage3mNote": "Наступний місяць {s} · сезон: жов ×{o}, лис ×{n}",
      "ovr.kpi.cross": "Одиниць доживе до порога",
      "ovr.kpi.crossNote": "Поріг {t} дня",
      "ovr.age": "Вік запасу",
      "ovr.ageCaption": "Скільки одиниць у якій корзині днів. Корзини 91+ — кандидати на надбавку за витриманий запас.",
      "ovr.age0_90": "0–90 днів",
      "ovr.age91_180": "91–180 днів",
      "ovr.age181plus": "181+ днів",
      "ovr.cross": "Одиниці, що доживають до порога",
      "ovr.crossCaption":
        "Розрахунок за правилом FIFO окремо в кожному складському пулі: запас у UK витрачається продажами UK, а не спільними по Європі. Без поділу на пули витриманий запас у UK не видно.",
      "ovr.crossNone": "Жодної позиції: увесь запас іде швидше за поріг.",
      "ovr.table": "Усі позиції",
      "ovr.tableCaption": "Відсортовані за сумою заморожених грошей і прогнозу зберігання на 3 місяці.",
      "ovr.tableSr": "Затоварені позиції FBA",
      "ovr.gaps": "Чого бракує в даних",
      "ovr.col.sku": "SKU",
      "ovr.col.asin": "ASIN",
      "ovr.col.onHand": "Залишок",
      "ovr.col.inbound": "У дорозі",
      "ovr.col.velocity": "Шт/добу",
      "ovr.col.dos": "Запас, дн",
      "ovr.col.dosInb": "Дн з дорогою",
      "ovr.col.excess": "Надлишок",
      "ovr.col.cross": "За порогом",
      "ovr.col.crossDate": "Коли",
      "ovr.col.unitCost": "Собів.",
      "ovr.col.stockValue": "Запас, EUR",
      "ovr.col.storage12m": "Зберігання 12 міс",
      "ovr.col.storageNext": "Наст. міс",
      "ovr.col.storage3m": "Прогноз 3 міс",
      "ovr.col.rank": "Разом",
      "ovr.col.where": "Де",
      "ovr.total": "Разом",

      /* --- Розділ «Країни доставки»: зріз за країною отримувача --- */
      "page.geo": "Країни доставки",
      "geo.subtitle": "Скільки й чого продано в країнах, куди їдуть посилки",
      "geo.empty":
        "У вивантаженні немає вузла countries. Його збирає src/Export-CountrySales.ps1 з Orders Report і вкладає src/Add-CountriesToPayload.ps1.",
      "geo.range": "Період {from} — {to} · {d} днів · Orders Report, поле ship-country",
      "geo.caption":
        "Країна тут — куди поїхала посилка, а не де оформлено замовлення. Покупка на вітрині однієї країни з доставкою в сусідню потрапить сюди за адресою отримувача, а в розділі «Маржа» залишиться всередині вітрини. Період задано під час вивантаження і загальному фільтру він не підпорядковується. Усі суми в євро: вітрини єврозонні, перерахунок курсів не застосовувався.",
      "geo.countryPick": "Країна",
      "geo.allCountries": "Усі країни ({n})",
      "geo.byCountry": "Продажі за країнами",
      "geo.byCountryCaption": "Сума з ПДВ за весь період",
      "geo.trend": "Помісячно",
      "geo.trendCaption":
        "Виторг нетто і прибуток — обидва в євро, тому шкала одна. Штуки — інша одиниця, вони в таблиці.",
      "geo.products": "Товари: штуки та гроші",
      "geo.productsCaption":
        "Кожен рядок сходиться: нетто − повернення − комісії − реклама − собівартість = прибуток. Комісії, рекламу та повернення рознесено з вітринної статистики за часткою штук; собівартість — закупівельна ціна на дату продажу. Назву зведено до одного варіанта на ASIN — того, на який припало найбільше проданих одиниць.",
      "geo.gaps": "Чого в цих цифрах немає",      "geo.gap.tz": "День береться з purchase-date в UTC — на межах періоду це може відрізнятися від місцевого часу вітрини.",      "geo.gap.storefront": "Скасовані позиції та канал Non-Amazon виключені; замовлення, ще не відвантажені, враховано як продані.",
      "geo.kpi.gross": "Сума продажів",
      "geo.kpi.grossNote": "З ПДВ — те, що заплатили покупці",      "geo.kpi.units": "Продано штук",
      "geo.kpi.unitsNote": "Одиниць товару, а не позицій замовлення",      "geo.kpi.orders": "Замовлень",
      "geo.kpi.ordersNote": "Середній чек {v} з ПДВ",      "geo.col.country": "Країна",
      "geo.col.product": "Товар",
      "geo.col.asin": "ASIN",
      "geo.col.units": "Штук",      "geo.col.gross": "Сума з ПДВ",      "geo.col.month": "Місяць",
      "geo.kpi.profit": "Прибуток",
      "geo.kpi.profitNote": "Маржа {m} від виторгу нетто · підписка Amazon не рознесена",
      "geo.kpi.profitNoCogs": "Закупівельна ціна невідома — прибуток не рахується",
      "geo.kpi.marginMeter": "Маржа",
      "geo.kpi.grossShare": "{p} вибірки",
      "geo.kpi.netRev": "Виторг нетто",
      "geo.kpi.netRevNote": "Без ПДВ ({v}) і промо-знижок ({p})",
      "geo.kpi.refunds": "Повернення",
      "geo.kpi.refundsNote": "≈{n} шт · рознесено з вітринної статистики",
      "geo.kpi.fees": "Комісії Amazon",
      "geo.kpi.feesNote": "{p} виторгу нетто · з поправкою на напрямок доставки",
      "geo.kpi.ads": "Реклама",
      "geo.kpi.adsNote": "{p} виторгу нетто · рознесено за часткою штук",
      "geo.kpi.cogs": "Собівартість",
      "geo.kpi.cogsNote": "Закупівельна ціна на дату продажу — точна, не рознесена",
      "geo.col.netRev": "Нетто",
      "geo.col.refunds": "Повернення",
      "geo.col.fees": "Комісії",
      "geo.col.ads": "Реклама",
      "geo.col.cogs": "Собів.",
      "geo.col.profit": "Прибуток",
      "geo.col.margin": "Маржа",
      "geo.gap.method": "Комісії, реклама та повернення приходять від Amazon за вітриною і товаром — країни отримувача в цих даних немає. Тут їх рознесено за часткою штук товару, що поїхала в країну з тієї ж вітрини того ж місяця. Це розрахункова модель; виторг, штуки й собівартість — точні.",
      "geo.gap.fba": "FBA-комісія залежить від напрямку: доставка в країну без складу Amazon дорожча за домашню. Різницю враховано за фактичними ставками з банківських розрахунків за останні місяці періоду; на раніші місяці ставки прийнято тими ж.",
      "geo.gap.refundDate": "Повернення враховано за датою події всередині періоду: повернення, що сталося після його кінця, у ці цифри не потрапило.",
      "geo.gap.subs": "Підписка продавця — акаунтна і за країнами не рознесена; тут це менше третини відсотка виторгу.",
      "geo.partialMonth": "на графіку немає неповного місяця: {m}",
