...
(function (global) {
  ...
  var DICT = {
    ...
    ru: {
      ...
      "geo.trend": "Помесячно",
      "geo.trendCaption":
        "На графике деньги. Штуки — другая единица измерения, вторая ось Y для них не заводится; они в таблице.",
      "geo.products": "Товары: штуки и деньги",
      "geo.productsCaption":
        "Название приведено к одному варианту на ASIN — тому, на который пришлось больше всего проданных единиц: на Amazon.es и Amazon.de один и тот же товар назван по-разному.",
      "geo.gaps": "Чего в этих цифрах нет",
      "geo.gap.returns": "Возвратов нет: показано заказанное за период, а не оставшееся у покупателей.",
      "geo.gap.tz": "День берётся по purchase-date в UTC — на границах периода это может отличаться от местного времени витрины.",
      "geo.gap.fees": "Комиссий, рекламы и себестоимости нет: это выручка, а не прибыль. Расходы — в разделах «Анализ продаж» и «Маржа».",
      ...
      "geo.kpi.shareOfAll": "Доля в выборке",
      "geo.kpi.units": "Продано штук",
      "geo.kpi.unitsNote": "Единиц товара, а не позиций заказа",
      "geo.kpi.net": "Без НДС",
      "geo.kpi.netNote": "НДС внутри суммы: {v}",
      "geo.kpi.orders": "Заказов",
      "geo.kpi.ordersNote": "Уникальных номеров заказа",
      "geo.kpi.avg": "Средний чек",
      "geo.kpi.avgNote": "Сумма с НДС на один заказ",
      "geo.col.country": "Страна",
      "geo.col.product": "Товар",
      "geo.col.asin": "ASIN",
      "geo.col.units": "Штук",
      "geo.col.orders": "Заказов",
    ...
    en: {
      ...
      "geo.trend": "By month",
      "geo.trendCaption":
        "The chart shows money. Units are a different unit of measure and get no second Y axis; they are in the table.",
      "geo.products": "Products: units and money",
      "geo.productsCaption":
        "The title is reduced to one variant per ASIN — the one carrying the most units sold: Amazon.es and Amazon.de name the same product differently.",
      "geo.gaps": "What these figures do not include",
      "geo.gap.returns": "No returns: this is what was ordered in the period, not what buyers kept.",
      "geo.gap.tz": "The day comes from purchase-date in UTC — at the period edges that can differ from the storefront local time.",
      "geo.gap.fees": "No fees, advertising or COGS: this is revenue, not profit. Costs live in Sales analysis and Margin.",
      ...
      "geo.kpi.shareOfAll": "Share of the selection",
      "geo.kpi.units": "Units sold",
      "geo.kpi.unitsNote": "Units of product, not order lines",
      "geo.kpi.net": "Excl. VAT",
      "geo.kpi.netNote": "VAT inside the amount: {v}",
      "geo.kpi.orders": "Orders",
      "geo.kpi.ordersNote": "Distinct order numbers",
      "geo.kpi.avg": "Average order",
      "geo.kpi.avgNote": "Amount incl. VAT per order",
    ...
    uk: {
      ...
      "geo.trend": "Помісячно",
      "geo.trendCaption":
        "На графіку гроші. Штуки — інша одиниця виміру, другої осі Y для них не заводимо; вони в таблиці.",
      "geo.products": "Товари: штуки та гроші",
      "geo.productsCaption":
        "Назву приведено до одного варіанта на ASIN — того, на який припало найбільше проданих одиниць: на Amazon.es і Amazon.de той самий товар названо по-різному.",
      "geo.gaps": "Чого в цих цифрах немає",
      "geo.gap.returns": "Повернень немає: показано замовлене за період, а не те, що лишилося в покупців.",
      "geo.gap.tz": "День береться з purchase-date в UTC — на межах періоду це може відрізнятися від місцевого часу вітрини.",
      "geo.gap.fees": "Комісій, реклами та собівартості немає: це виторг, а не прибуток. Витрати — у розділах «Аналіз продажів» і «Маржа».",
      ...
      "geo.kpi.shareOfAll": "Частка у вибірці",
      "geo.kpi.units": "Продано штук",
      "geo.kpi.unitsNote": "Одиниць товару, а не позицій замовлення",
      "geo.kpi.net": "Без ПДВ",
      "geo.kpi.netNote": "ПДВ усередині суми: {v}",
      "geo.kpi.orders": "Замовлень",
      "geo.kpi.ordersNote": "Унікальних номерів замовлення",
      "geo.kpi.avg": "Середній чек",
      "geo.kpi.avgNote": "Сума з ПДВ на одне замовлення",
      "geo.col.country": "Країна",
      "geo.col.product": "Товар",
      "geo.col.asin": "ASIN",
      "geo.col.units": "Штук",
      "geo.col.orders": "Замовлень",
